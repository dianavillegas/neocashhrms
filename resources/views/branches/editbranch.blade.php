...
<div class="br-pageheader pd-y-15 pd-l-20">
      ...
      <div class="br-pagebody">
        ...
        <div class="br-section-wrapper">
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-18 mg-b-10">Edit Branch</h6>
    <form action="{{route('updatebranch')}}" method="POST" data-parsley-validate="">
            ...
            <div class="row no-gutters">
              ...
              <div class="col-md-6 mg-t--1 mg-md-t-0">
                <div class="form-group mg-md-l--1">
                 ...
                 <input type="text" name="address" value="{{$branch->address}}" class="form-control" id="inputEmail3" placeholder="Address of Branch" required="">
                </div>
              </div><!-- col-4 -->
