...
<div class="br-pageheader pd-y-15 pd-l-20">
    ...
    <form action="{{route('submitloan')}}" method="POST" enctype="multipart/form-data" data-parsley-validate="">
              ...
              <div class="col-md-4 mg-t--1 mg-md-t-0">
                <div class="form-group mg-md-l--1">
                  <label class="form-control-label">No. of Terms: <span class="tx-danger">*</span></label>
                   <input type="text" name="terms" class="form-control" id="inputEmail3" placeholder="No. of terms payable" required="">
                </div>
              </div>
              <div class="col-md-4 mg-t--1 mg-md-t-0">
                <div class="form-group mg-md-l--1">
                  <label class="form-control-label">Amount: <span class="tx-danger">*</span></label>
                   <input type="text" name="amount" class="form-control" id="inputEmail3" placeholder="Amount of Loan" required="">
                </div>
              </div>
              <div class="col-md-4 mg-t--1 mg-md-t-0">
                <div class="form-group mg-md-l--1">
                  <label class="form-control-label">Reason: <span class="tx-danger">*</span></label>
                   <input type="text" name="reason" class="form-control" id="inputEmail3" placeholder="Reason For Loan" required="">
                </div>
              </div>
